...
import { TermsSectionList } from "../TermsSectionList";
import type { TermsSection } from "@/content/terms";

describe("TermsSectionList", () => {
  ...
  describe("Rendering", () => {
    it("renders all sections", () => {
      render(<TermsSectionList sections={mockSections} />);
      expect(
    ...
    it("renders empty when no sections provided", () => {
      render(<TermsSectionList sections={[]} />);
      const container = screen.getByRole("list");
  ...
  describe("Styling", () => {
    ...
    it("applies custom className", () => {
      render(
        <TermsSectionList sections={mockSections} className="custom-class" />
      );
      const container = screen.getByRole("list");
  ...
  describe("Integration with TermsSection", () => {
